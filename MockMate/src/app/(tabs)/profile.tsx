...
function MenuItem({ icon, label, onPress, showChevron = true, badge }: MenuItemProps) {
  return (
    <Pressable
      onPress={onPress}
    ...
    <View className="flex-1 bg-gray-50">
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
              ...
              <View className="flex-row items-center mb-1">
                ...
                {isVIP && (
                  <Pressable onPress={handleVIPStatus}>
                    <Badge text="VIP" variant="warning" />
                  </Pressable>
                )}
              </View>
        ...
        <View className="bg-white mt-4 px-4 py-2">
          <Text variant="heading" className="text-base text-gray-500 uppercase mb-2 mt-2">
            Career
          </Text>
          <MenuItem
            icon="History"
