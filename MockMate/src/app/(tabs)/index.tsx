...
export default function HomeScreen() {
	...
	const featuredInterviews = React.useMemo(() => {
		...
		return [...interviews].sort((a, b) => b.rating - a.rating).slice(0, 5);
	}, [interviews]);
	...
	const todayQuest: Quest = {
		...
		type: "complete_interviews",
		target: 1,
		current: gamification?.completedInterviewsToday ?? 0,
		reward: 50,
		completed: (gamification?.completedInterviewsToday ?? 0) >= 1,
		icon: "CheckCircle",
	};
