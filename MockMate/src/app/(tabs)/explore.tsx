...
import { View, FlatList, TextInput, Pressable, ScrollView } from 'react-native';
...
import type { Industry, Difficulty } from '../../types/interview';
...
export default function ExploreScreen() {
  ...
  const filteredInterviews = useMemo(() => {
    ...
    return interviews.filter((interview) => {
      ...
      // Industry filter
      const matchesIndustry = !selectedIndustry || interview.industry === selectedIndustry;

      // Difficulty filter
      const matchesDifficulty = !selectedDifficulty || interview.difficulty === selectedDifficulty;
  ...
  const hasActiveFilters = searchQuery.trim() !== '' || selectedIndustry !== null || selectedDifficulty !== null;
