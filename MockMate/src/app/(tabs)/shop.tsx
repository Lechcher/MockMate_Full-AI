...
const VIP_PLAN: VIPPlan = {
	...
	discount: 50,
	revenueCatProductId: "vip_yearly",
	features: [
			...
			<ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
				...
				{!isVIP && (
					<View className="px-4 pt-6 pb-4">
						...
						<ShopCard item={VIP_PLAN} onPress={handleUpgradeToVIP} />
					</View>
				)}
				...
				<View className="px-4 pb-4">
					...
					<ShopCard
						item={{
							...POWER_UPS[0],
							price: Math.floor(POWER_UPS[0].price / 2),
						}}
							...
							<View className="flex-row items-center justify-between">
								...
								<View className="flex-row items-center">
									...
									<Text variant="body" className="text-green-600 font-bold">
										{currentGems - (selectedPowerUp?.price || 0)}
									</Text>
								</View>
							</View>
						</View>
