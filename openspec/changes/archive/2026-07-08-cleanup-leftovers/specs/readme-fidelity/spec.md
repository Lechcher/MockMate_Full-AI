# Capability: readme-fidelity

MockMate's user-facing documentation (`MockMate/README.md` and root
`README.md`) reflects the implementation in the repository at HEAD.
Sections describing technology choice (auth backend, dev-client
requirement, supported platforms) MUST match the live code.
