# Capability: secrets-redaction

`MockMate/.env.example` is the only committed env file. It MUST NOT
contain real credentials — only placeholder values suitable for
inclusion in version control and forks.
